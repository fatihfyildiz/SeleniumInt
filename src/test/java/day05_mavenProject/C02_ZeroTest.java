...
public class C02_ZeroTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String actualBasariliYazisiElementi= basariliYazisiElementi.getText();
        String expectedBasariliYazisiElementi= "The payment was successfully submitted.";

        if (actualBasariliYazisiElementi.equals(expectedBasariliYazisiElementi)) {
